 ...
 * docker compose exec backend php tests/ApiMinioIntegrationTest.php
...
try {
    ...
    // Verify the exact file copied from backend/tests/fixtures by minio-init.
    ...
    expectIntegration((string) $storedFixture["Body"] === $fixtureContents, "The MinIO fixture differs from backend/tests/fixtures/minio-init.txt");
    ...
    expectStatus(requestApi("POST", "/api/pages/" . $pageId . "/publish"), 200, "Draft publication");
    ...
    echo "[OK] POST publish and GET /api/pages/{id}\n";
